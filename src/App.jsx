...
function App(){
  const headers=Object.keys(tableHeaders).map(header=>tableHeaders[header]);
        ...
        <RenderTable headers={headers} data={data} headerStyle="w-10 text-left border-1 border-gray-200 p-2" dataRowStyle="odd:bg-gray-300 even:bg-white" dataContentStyle="border-1 border-gray-200 p-2"/>  
        </div>
}
export default App; 